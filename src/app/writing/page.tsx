...
const featuredPapers: FeaturedPaper[] = [
  {
    ...
    description: "Analysis of the global semiconductor supply chain and the strategic importance of Taiwan (TSMC). Examination of market dependencies, Fab investment cycles ($7–50B capital requirement), and geopolitical tensions in the silicon age.",
    buttons: null,
  },
  {
  ...
  },
  {
    ...
    description: "Interdisciplinary project analyzing the German pension system. Investigation of inflation dynamics and mathematical demonstration of the compound interest effect through S&P 500 backtesting.",
    buttons: null,
  },
  {
    ...
    buttons: [
      ...
      { label: "Text ↓", href: "/papers/bitcoin.docx" },
    ],
  },
];
