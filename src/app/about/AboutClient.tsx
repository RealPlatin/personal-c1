    ...
    sections: [
      {
        ...
        items: [
          "Conducted a full life-cycle analysis of EVs, evaluating raw material extraction, battery production, usage and recycling, and comparing the ecological footprint to combustion engines.",
        ],
      },
    ],
...
const interests = ["Macroeconomics", "Geopolitics", "Chess", "Fashion", "Endurance Sports"];
    ...
    <div className="container section">
      ...
      <div style={{ position: "relative" }}>
        ...
        {timeline.map((item, i) => (
          ...
          >
            {/* Period */}
            <div className="timeline-period" style={{ textAlign: "right", paddingTop: "0.15rem", paddingRight: "1.25rem" }}>
              <span
                style={{
                  fontFamily: "var(--font-mono)",
                  fontSize: "0.65rem",
